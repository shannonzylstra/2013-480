<<<<<<< HEAD
︠5768a0b9-2682-4e55-8771-33b2efce4c9e︠
n = 15
a = prime_range(100)
for i,p in enumerate(a):
    a[i] = p % n
a
︡8955c547-992a-416d-ad96-56e096bb4f99︡{"stdout":"[2, 3, 5, 7, 11, 13, 2, 4, 8, 14, 1, 7, 11, 13, 2, 8, 14, 1, 7, 11, 13, 4, 8, 14, 7]"}︡{"stdout":"\n"}︡
︠2bfb035b-c0da-4b67-8911-dcd822e6a3c7︠
n = 15
a = prime_range(100)
for i in range(len(a)):
    a[i] %= n
a
︡000dad16-2a9a-45c3-9aad-ddf0136a7768︡{"stdout":"[2, 3, 5, 7, 11, 13, 2, 4, 8, 14, 1, 7, 11, 13, 2, 8, 14, 1, 7, 11, 13, 4, 8, 14, 7]"}︡{"stdout":"\n"}︡
︠f4397714-50da-4abd-acfd-c1d2a3b845df︠
n = 15
a = prime_range(100)
a = [p%n for p in a]
a
︡0a279b99-20a1-4ace-9358-84f3b1c2c993︡{"stdout":"[2, 3, 5, 7, 11, 13, 2, 4, 8, 14, 1, 7, 11, 13, 2, 8, 14, 1, 7, 11, 13, 4, 8, 14, 7]"}︡{"stdout":"\n"}︡
︠60b48bdb-f99a-48b4-a978-2602118b6b97︠
